$(function(){
	$(".banner-main").find("dt").mouseenter(function(){
		$(".banner-main").find("dl").css("display","inline-block");	
		console.log("123123")
	})
	$(".banner-main").find("dl").mouseleave(function(){
		$(".banner-main").find("dl").css("display","none");	
	})
	...
	$("#inpt").find("input").eq(0).click(function(){
